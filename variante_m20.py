...
with open('10_pontos.csv', 'r') as arquivo_csv:
...
with open (f'resultados_m20_10pontos_{execucao}.csv', 'a', newline='') as arquivo_csv:
    escritor_csv = csv.writer(arquivo_csv)
    if os.stat(f'resultados_m20_10pontos_{execucao}.csv').st_size == 0:
